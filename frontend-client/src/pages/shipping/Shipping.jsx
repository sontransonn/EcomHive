...
import { place_order } from "../../redux/slices/orderSlice"
                            ...
                            <div className="bg-white p-6 shadow-sm rounded-md">
                                ...
                                {res && (
                                    <div className='flex flex-col gap-1'>
                                        ...
                                        <p className='text-slate-600 text-sm'>Email to sontransonn@gmail.com</p>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="pl-3 md-lg:pl-0">
                            <div className='bg-white font-medium p-5 text-slate-600 flex flex-col gap-3'>
                                ...
                                <button
                                    ...
                                    ${res ? 'bg-orange-500' : 'bg-orange-300'} text-sm text-white uppercase`}
                                >
                                    Place Order
                                </button>
                            </div>
