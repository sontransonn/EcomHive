...
const ChatSeller = () => {
    ...
    // Bắn socket tới seller với message mới nhất ngay sau khi gửi tin nhắn thành công
    useEffect(() => {
        if (successMessage) {
    ...
    // Xử lý socket khi seller gửi tin nhắn tới
    useEffect(() => {
    ...
    // Cập nhật lại message mới nhất ngay sau khi xử lý socket 
    useEffect(() => {
        if (recevedMessage) {
